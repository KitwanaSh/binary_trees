...
/**
 * check_sub_tree_Left - checks if the node has something
 * specified
...
/**
 * check_sub_tree_Right - checks for all node to have a ceratin value
 * @node: node in the tree to verify condition
...
/**
 * binary_tree_is_bst - bings it to where
